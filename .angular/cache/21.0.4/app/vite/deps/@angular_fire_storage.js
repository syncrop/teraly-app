...
// node_modules/@angular/fire/node_modules/@firebase/storage/dist/index.esm.js
...
function extractBucket2(host, config) {
  const bucketString = config?.[CONFIG_STORAGE_BUCKET_KEY2];
  if (bucketString == null) {
    return null;
  }
